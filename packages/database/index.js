...
// Export models
export { getAssetModel, createAssetSchema } from './src/models/Asset';
export { getThumbnailModel, createThumbnailSchema } from './src/models/Thumbnail';
 ...
 */
export async function waitForConnection(maxWaitMs = 60000) {
